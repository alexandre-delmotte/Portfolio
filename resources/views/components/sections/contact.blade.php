<section id="contact" class="py-24 bg-site-section">
    <div class="max-w-7xl mx-auto px-6 lg:px-8">
        ...
        <x-utils.section-title title="Contactez-moi" />

        <div class="grid grid-cols-1 lg:grid-cols-2 gap-12 items-start">

            <div class="space-y-8">
                <div>
                    <h3 class="text-2xl font-bold text-white mb-4">Prêt à rejoindre votre équipe</h3>
                    <p class="text-gray-400 text-lg leading-relaxed text-justify">
                        Je suis actuellement à la recherche d'une opportunité en tant que <strong>Développeur Web Junior</strong> pour intégrer une entreprise dynamique. Mon profil vous intéresse ? Vous avez un poste à pourvoir ? Discutons-en !
                    </p>
                </div>

                <ul class="space-y-6">
                    <x-utils.contact-item title="Téléphone" value="0471/21 16 03" link="tel:+32471211603">
                    ...
                    <x-utils.contact-item title="Email" value="alexandre.delmotte.dev@gmail.com" link="mailto:alexandre.delmotte.dev@gmail.com">
                    ...
                    <x-utils.contact-item title="Localisation" value="1360 Perwez, Belgique">
            ...
            <form action="{{ route('contact.send') }}" method="POST" class="bg-site-card p-8 rounded-2xl border border-white/5 shadow-xl space-y-6">
                ...
                <div>
                    <label for="subject" class="block text-sm font-medium text-gray-400 mb-2">Sujet</label>
                    <input type="text" id="subject" name="subject" placeholder="Proposition d'entretien / Offre d'emploi..." class="w-full bg-site-bg border border-gray-700 rounded-lg px-4 py-3 text-white focus:outline-none focus:border-site-blue focus:ring-1 focus:ring-site-blue transition-colors">
                </div>

                <div>
                    <label for="message" class="block text-sm font-medium text-gray-400 mb-2">Message</label>
                    <textarea id="message" name="message" rows="5" placeholder="Bonjour Alexandre, votre profil a retenu notre attention pour un poste de développeur..." class="w-full bg-site-bg border border-gray-700 rounded-lg px-4 py-3 text-white focus:outline-none focus:border-site-blue focus:ring-1 focus:ring-site-blue transition-colors resize-none"></textarea>
                </div>
